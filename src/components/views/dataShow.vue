  ...
  export default {
    ...
    methods: {
      initData() {
        ...
        let monthList = []
        switch(nowMonth){
          case 11: monthList = [10]
           break;
          case 12: monthList = [10, 11]
           break;
          case 1: monthList = [10, 11, 12]
           break;
          case 2: monthList = [10, 11, 12, 1]
           break;
          case 3: monthList = [10, 11, 12, 1, 2]
           break;
          case 4: monthList = [10, 11, 12, 1, 2, 3]
           break;
          case 5: monthList = [10, 11, 12, 1, 2, 3]
           break;
        }
